...
class StartPoint_Customizer {
    ...
    public static function StartPoint_Sections($wp_customize) {
        ...
        $wp_customize->add_section('home_feature_area_section4', array(
            'title' => __('Fourth Feature Area', 'start-point'),
            'description' => __('Allows you to setup fourth feature area section for StartPoint Theme.', 'start-point'),
            'panel' => 'home_page_feature_area_panel',
            'priority' => '',
            'capability' => 'edit_theme_options'
                )
        ...
        /**
         * Home Page feature area 5
         */
        $wp_customize->add_section('home_feature_area_section5', array(
            'title' => __('Fifth Feature Area', 'start-point'),
            'description' => __('Allows you to setup fifth feature area section for StartPoint Theme.', 'start-point'),
            'panel' => 'home_page_feature_area_panel',
            'priority' => '',
            'capability' => 'edit_theme_options'
                )
        ...
        /**
         * Home Page feature area 6
         */
        $wp_customize->add_section('home_feature_area_section6', array(
            'title' => __('Sixth Feature Area', 'start-point'),
            'description' => __('Allows you to setup sixth feature area section for StartPoint Theme.', 'start-point'),
            'panel' => 'home_page_feature_area_panel',
            'priority' => '',
            'capability' => 'edit_theme_options'
                )
...
/**
    ...
    public static function StartPoint_Section_Content() {
        $section_content = array(
            ...
            'home_feature_area_section4' => array(
                'startpoint_threecolumn_fet_font4',
                'startpoint_threecolumn_fet_title4',
                'startpoint_services_title_link4',
                'startpoint_threecolumn_fet_desc4'
            ),
            'home_feature_area_section5' => array(
                'startpoint_threecolumn_fet_font5',
                'startpoint_threecolumn_fet_title5',
                'startpoint_services_title_link5',
                'startpoint_threecolumn_fet_desc5'
            ),
            'home_feature_area_section6' => array(
                'startpoint_threecolumn_fet_font6',
                'startpoint_threecolumn_fet_title6',
                'startpoint_services_title_link6',
                'startpoint_threecolumn_fet_desc6'
            ),
    ...
    public static function StartPoint_Settings() {
        $startpoint_settings = array(
            ...
            // Sicth Feature Box
            'startpoint_threecolumn_fet_font6' => array(
                'id' => 'startpoint_options[startpoint_threecolumn_fet_font6]',
                'label' => __('Third Feature Image', 'start-point'),
                'description' => __('Enter the CSS class of the icons you want to use on your 3 column feature. You can find a list of icon classes To increase icon sizes relative to their container, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes.', 'start-point'),
                'type' => 'option',
                'setting_type' => 'text',
            ...
            'startpoint_threecolumn_fet_title6' => array(
                'id' => 'startpoint_options[startpoint_threecolumn_fet_title6]',
                'label' => __('Third Feature Heading', 'start-point'),
                'description' => __('Mention the heading for Third Feature Box that will showcase your business services.', 'start-point'),
                'type' => 'option',
                'setting_type' => 'textarea',
            ...
            'startpoint_threecolumn_fet_desc6' => array(
                'id' => 'startpoint_options[startpoint_threecolumn_fet_desc6]',
                'label' => __('Third Feature Description', 'start-point'),
                'description' => __('Write short description for your Third Feature Box.', 'start-point'),
                'type' => 'option',
                'setting_type' => 'textarea',
            ...
            'startpoint_services_title_link6' => array(
                'id' => 'startpoint_options[startpoint_services_title_link6]',
                'label' => __('Third feature Link', 'start-point'),
                'description' => __('Enter your text for Third feature Link.', 'start-point'),
                'type' => 'option',
                'setting_type' => 'link',
            ...
            // Fourth Feature Box
            'startpoint_threecolumn_fet_font4' => array(
                'id' => 'startpoint_options[startpoint_threecolumn_fet_font4]',
                'label' => __('Third Feature Image', 'start-point'),
                'description' => __('Enter the CSS class of the icons you want to use on your 3 column feature. You can find a list of icon classes To increase icon sizes relative to their container, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes.', 'start-point'),
                'type' => 'option',
                'setting_type' => 'text',
            ...
            'startpoint_threecolumn_fet_title4' => array(
                'id' => 'startpoint_options[startpoint_threecolumn_fet_title4]',
                'label' => __('Third Feature Heading', 'start-point'),
                'description' => __('Mention the heading for Third Feature Box that will showcase your business services.', 'start-point'),
                'type' => 'option',
                'setting_type' => 'textarea',
            ...
            'startpoint_threecolumn_fet_desc4' => array(
                'id' => 'startpoint_options[startpoint_threecolumn_fet_desc4]',
                'label' => __('Third Feature Description', 'start-point'),
                'description' => __('Write short description for your Third Feature Box.', 'start-point'),
                'type' => 'option',
                'setting_type' => 'textarea',
            ...
            'startpoint_services_title_link4' => array(
                'id' => 'startpoint_options[startpoint_services_title_link4]',
                'label' => __('Third feature Link', 'start-point'),
                'description' => __('Enter your text for Third feature Link.', 'start-point'),
                'type' => 'option',
                'setting_type' => 'link',
            ...
            // Fith Feature Box
            'startpoint_threecolumn_fet_font5' => array(
                'id' => 'startpoint_options[startpoint_threecolumn_fet_font5]',
                'label' => __('Third Feature Image', 'start-point'),
                'description' => __('Enter the CSS class of the icons you want to use on your 3 column feature. You can find a list of icon classes To increase icon sizes relative to their container, use the fa-lg (33% increase), fa-2x, fa-3x, fa-4x, or fa-5x classes.', 'start-point'),
                'type' => 'option',
                'setting_type' => 'text',
            ...
            'startpoint_threecolumn_fet_title5' => array(
                'id' => 'startpoint_options[startpoint_threecolumn_fet_title5]',
                'label' => __('Third Feature Heading', 'start-point'),
                'description' => __('Mention the heading for Third Feature Box that will showcase your business services.', 'start-point'),
                'type' => 'option',
                'setting_type' => 'textarea',
            ...
            'startpoint_threecolumn_fet_desc5' => array(
                'id' => 'startpoint_options[startpoint_threecolumn_fet_desc5]',
                'label' => __('Third Feature Description', 'start-point'),
                'description' => __('Write short description for your Third Feature Box.', 'start-point'),
                'type' => 'option',
                'setting_type' => 'textarea',
            ...
            'startpoint_services_title_link5' => array(
                'id' => 'startpoint_options[startpoint_services_title_link5]',
                'label' => __('Third feature Link', 'start-point'),
                'description' => __('Enter your text for Third feature Link.', 'start-point'),
                'type' => 'option',
                'setting_type' => 'link',
