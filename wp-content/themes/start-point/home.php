...
<div id="page">
	<div class="flexslider">
		<ul class="slides">
			<li>
<?php
				if (startpoint_get_option('startpoint_slidevideo1') != '')
				{
?>
					<div class="videoWrapper">
						<?= startpoint_get_option('startpoint_slidevideo1'); ?>
					</div>
<?php
				}
				else
				{
					if (startpoint_get_option('startpoint_slideimage1') != '')
					{
?>
						<img src="<?= startpoint_get_option('startpoint_slideimage1'); ?>" alt="" title="" />
<?php
					}
					else
					{
?>
						<img src="<?= get_template_directory_uri(); ?>/images/slider1.jpg" alt="" title="" />
<?php
					}
				}
?>
...
<?php
							if (startpoint_get_option('startpoint_sliderheading1') != '')
							{
?>
								<h1><?= startpoint_get_option('startpoint_sliderheading1'); ?></h1>
<?php
							}
							else
							{
...
<?php
								if (startpoint_get_option('startpoint_sliderdes1') != '')
								{
?>
									<div id="maindiv">
										<div id="div1">
											&nbsp;<h3><?= startpoint_get_option('startpoint_sliderdes1'); ?></h3>
										</div>
										<div id="div2">
											&nbsp;<h3><?= startpoint_get_option('startpoint_sliderdes1'); ?></h3>
										</div>
...
<?php
								...
								if (startpoint_get_option('startpoint_Slider_butotntext1') != '')
								{
?>
									<p><a href="<?= startpoint_get_option('startpoint_Slider_buttonlink1'); ?>"><?= startpoint_get_option('startpoint_Slider_butotntext1'); ?></a></p>
<?php
								}
?>
						</div>
...
<?php
							if (startpoint_get_option('startpoint_threecolumn_fet_font1') != '')
							{
?>
								<p><i class="<?= startpoint_get_option('startpoint_threecolumn_fet_font1'); ?>"></i></p>
<?php
							}
							else
							{
...
<?php
							...
							if (startpoint_get_option('startpoint_threecolumn_fet_title1') != '')
							{
?>
								<h1>
<?php
									if (startpoint_get_option('startpoint_services_title_link1') != '')
									{
?>
										<a href="<?= startpoint_get_option('startpoint_services_title_link1'); ?>">
<?php
									}
											echo startpoint_get_option('startpoint_threecolumn_fet_title1');
...
<?php
							...
							if (startpoint_get_option('startpoint_threecolumn_fet_desc1') != '')
							{
?>
								<p><?= startpoint_get_option('startpoint_threecolumn_fet_desc1'); ?></p>
<?php
							}
							else
							{
...
?>
					...
					<div class="col-md-4 box2 animated bottom-to-top">
						...
						<div class="three-column-box">
<?php
							if (startpoint_get_option('startpoint_threecolumn_fet_font2') != '')
							{
?>
								<p><i class="<?= startpoint_get_option('startpoint_threecolumn_fet_font2'); ?>"></i></p>
<?php
							}
							else
							{
...
<?php
							...
							if (startpoint_get_option('startpoint_threecolumn_fet_title2') != '')
							{
?>
								<h1>
<?php
									if (startpoint_get_option('startpoint_services_title_link2') != '')
									{
?>
										<a href="<?= startpoint_get_option('startpoint_services_title_link2'); ?>">
<?php
									}
											echo startpoint_get_option('startpoint_threecolumn_fet_title2');
...
<?php
							...
							if (startpoint_get_option('startpoint_threecolumn_fet_desc2') != '')
							{
?>
								<p><?= startpoint_get_option('startpoint_threecolumn_fet_desc2'); ?></p>
<?php
							}
							else
							{
?>
								<p><a href="<?= esc_url('http://fortawesome.github.io/Font-Awesome/icons/'); ?>" target="_blank"><?php _e('Go to Font Awesome', 'start-point'); ?></a><?php _e(' and pick the icon of your choice. Copy the class of icon and paste it in Theme Option Panel.', 'start-point'); ?></p>
<?php
							}
?>
						</div>
					...
					<div class="col-md-4 box3 animated right-to-left">
						...
						<div class="three-column-box">
<?php
							if (startpoint_get_option('startpoint_threecolumn_fet_font3') != '')
							{
?>
								<p><i class="<?= startpoint_get_option('startpoint_threecolumn_fet_font3'); ?>"></i></p>
<?php
							}
							else
							{
...
<?php
							...
							if (startpoint_get_option('startpoint_threecolumn_fet_title3') != '')
							{
?>
								<h1>
<?php
									if (startpoint_get_option('startpoint_services_title_link3') != '')
									{
?>
										<a href="<?= startpoint_get_option('startpoint_services_title_link3'); ?>">
<?php
									}
										echo startpoint_get_option('startpoint_threecolumn_fet_title3');
...
<?php
							...
							if (startpoint_get_option('startpoint_threecolumn_fet_desc3') != '')
							{
?>
								<p><?= startpoint_get_option('startpoint_threecolumn_fet_desc3'); ?></p>
<?php
							}
							else
							{
			...
			<div class="row">
				<div class="three-column-container">
					<div class="col-md-4 box1 animated left-to-right">
						...
						<div class="three-column-box">
<?php
							if (startpoint_get_option('startpoint_threecolumn_fet_font4') != '')
							{
?>
								<p><i class="<?= startpoint_get_option('startpoint_threecolumn_fet_font4'); ?>"></i></p>
<?php
							}
							else
							{
...
<?php
							...
							if (startpoint_get_option('startpoint_threecolumn_fet_title4') != '')
							{
?>
								<h1>
<?php
									if (startpoint_get_option('startpoint_services_title_link4') != '')
									{
?>
										<a href="<?= startpoint_get_option('startpoint_services_title_link4'); ?>">
<?php
									}
										echo startpoint_get_option('startpoint_threecolumn_fet_title4');
...
<?php
							...
							if (startpoint_get_option('startpoint_threecolumn_fet_desc4') != '')
							{
?>
								<p><?= startpoint_get_option('startpoint_threecolumn_fet_desc4'); ?></p>
<?php
							}
							else
							{
...
?>
					...
					<div class="col-md-4 box2 animated bottom-to-top">
						...
						<div class="three-column-box">
<?php
							if (startpoint_get_option('startpoint_threecolumn_fet_font5') != '')
							{
?>
								<p><i class="<?= startpoint_get_option('startpoint_threecolumn_fet_font5'); ?>"></i></p>
<?php
							}
							else
							{
...
<?php
							...
							if (startpoint_get_option('startpoint_threecolumn_fet_title5') != '')
							{
?>
								<h1>
<?php
									if (startpoint_get_option('startpoint_services_title_link5') != '')
									{
?>
										<a href="<?= startpoint_get_option('startpoint_services_title_link5'); ?>">
<?php
									}
										echo startpoint_get_option('startpoint_threecolumn_fet_title5');
...
<?php
							...
							if (startpoint_get_option('startpoint_threecolumn_fet_desc5') != '')
							{
?>
								<p><?= startpoint_get_option('startpoint_threecolumn_fet_desc5'); ?></p>
<?php
							}
							else
							{
...
?>
					...
					<div class="col-md-4 box3 animated right-to-left">
						...
						<div class="three-column-box">
<?php
							if (startpoint_get_option('startpoint_threecolumn_fet_font6') != '')
							{
?>
								<p><i class="<?= startpoint_get_option('startpoint_threecolumn_fet_font6'); ?>"></i></p>
<?php
							}
							else
							{
...
<?php
							...
							if (startpoint_get_option('startpoint_threecolumn_fet_title6') != '')
							{
?>
								<h1>
<?php
									if (startpoint_get_option('startpoint_services_title_link6') != '')
									{
?>
										<a href="<?= startpoint_get_option('startpoint_services_title_link6'); ?>">
<?php
									}
										echo startpoint_get_option('startpoint_threecolumn_fet_title6');
...
<?php
							...
							if (startpoint_get_option('startpoint_threecolumn_fet_desc6') != '')
							{
?>
								<p><?= startpoint_get_option('startpoint_threecolumn_fet_desc6'); ?></p>
<?php
							}
							else
							{
